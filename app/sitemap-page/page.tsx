...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Ball Run 2048. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Ball Run 2048 sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Ball Run 2048' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Ball Run 2048?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Ball Run 2048.</p>
                </div>
            </div>
