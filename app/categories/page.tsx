...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Ball Run 2048 puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Ball Run 2048 categories'],
  alternates: {
